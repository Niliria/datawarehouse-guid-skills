...
INSERT OVERWRITE TABLE dwd_sales_门店销售_di PARTITION (pt='${PT_DATE}')
SELECT
    source.门店销售_id,
    ROW_NUMBER() OVER (ORDER BY source.门店销售_id) AS 门店销售_sk,
    ...
    'dws_sales_门店销售' AS source_system

FROM dws_sales_门店销售_di source
...
-- ========================================
SELECT
    'dwd_sales_门店销售_di' AS table_name,
    '${PT_DATE}' AS pt,
