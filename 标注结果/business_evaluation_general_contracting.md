# 字段标签标注结果 - business_evaluation_general_contracting

## 一、表基本信息

| 项目 | 内容 |
|------|------|
| 表名 | business_evaluation_general_contracting |
| 库名 | yummy |
| 行数 | 0（空表） |
| 表注释 | 商务评分【总包、精装修类】 |
| 主题域 | 评价域 |
...
| 11 | bidding_contract_score | varchar(255) | [不可加度量] | 招标合同（10分） |
