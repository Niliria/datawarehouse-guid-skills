#!/usr/bin/env python3
"""
Bus matrix Excel generator for dwm-5-bus-matrix skill.
...
def main():
    ...
    parser.add_argument("--table-profile", required=True, help="Path to dwm_bp_table_profile.csv")
    parser.add_argument("--subject-area", required=True, help="Path to dwm_bp_subject_area.csv")
    parser.add_argument("--fact-dim-ref", required=True, help="Path to dwm_dim_fact_ref.csv")
